...
1. The script can be further modified to filter the results based on features like Ballot ID, Demographics etc.
2. The script can also be modified to show results based on different types of elections like general elections, primary elections, special elections, presidential elections and electoral college elections. 
